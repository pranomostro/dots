...
static char *scriptfile     = "/usr/local/surf/script.js";
static char *styledir       = "/usr/local/surf/styles/";
static char *cachefolder    = "/usr/local/surf/cache/";
...
static char *cookiefile     = "/usr/local/surf/cookies.txt";
