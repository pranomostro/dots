...
static const KeyBinding bindings_motions[] = {
	...
	{ "g<Up>",              ALIAS("gt")                                 },
	{ "gr",                 ACTION(CURSOR_SCREEN_LINE_DOWN)             },
	{ "g<Down>",            ALIAS("gr")                                 },
...
static const KeyBinding bindings_textobjects[] = {
	...
	{ "gh",                 ACTION(TEXT_OBJECT_SEARCH_FORWARD)          },
...
static const KeyBinding bindings_visual[] = {
	{ "<C-h>",              ACTION(CURSORS_NEW_MATCH_NEXT)              },
