...
static const char col_purple[]      = "#6b0bbf";
static const char col_yellow[]      = "#ffb405";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_black, col_white,  col_purple },
	[SchemeSel] =  { col_yellow, col_white,  col_yellow  },
};
